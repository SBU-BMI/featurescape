...
u24p.buildUI = function (id) { // build User Interface
    ...
    u24p.cases.forEach(function (c) {
        ...
        ol.appendChild(li);
        li.innerHTML = '<a href="' + config.quipUrl + '?tissueId=' + c + '&cancerType=luad" target="_blank">' + c + '</a>, (<a href="http://www.cbioportal.org/case.do?cancer_study_id=luad_tcga&case_id=' + c.slice(0, 12) + '" target="_blank" style="color:red">cbio</a>) random seed:';
